			...
			if parses!=(pass_write)
				if commandset!=(cCOMMENT)
					if parses==(pass_init)
						...
						if commandset==(cDECLARE)        #needing to find virtual start, at object is difficult, there is no virtual, ostrip will use: ld...-Tdata calculated, objcopy --update-section, write memsize, ounused will include virtual point
